 ...
 */
package p61.unidad0303.vista;

import p61.unidad0303.vista.*;
 ...
 * @author emili
 */
public class Ventana0303 extends JFrame implements ActionListener{
    ...
    public Ventana0303(String title) throws HeadlessException {
        super(title);
    ...
    public void iniciarRadiosButton(){
    ...
    public void actionPerformed (ActionEvent e){
        switch (e.getActionCommand()) {
            case "Guardar":
                ...
                break;
            case "Cancelar":
                System.out.println(this.recuperarDatosIngresados()[1]);
                break;
            case "Varón":
                System.out.println(this.recuperarDatosIngresados()[2]);
                break;
            case "Mujer":
                System.out.println(this.recuperarDatosIngresados()[3]);
                break;
            case "Arquero":
                System.out.println(this.recuperarDatosIngresados()[4]);
                break;
            case "Defensa":
                System.out.println(this.recuperarDatosIngresados()[5]);
                break;
            case "Mediocampo":
                System.out.println(this.recuperarDatosIngresados()[6]);
                break;
            case "Delantero":
                System.out.println(this.recuperarDatosIngresados()[7]);
                break;
            default:
                break;
        }
    ...
    public String []recuperarDatosIngresados(){
        ...
        if(this.jCheckBoxList.get(0).isSelected()){
            retorno[2]="SI";
        }else{
            retorno[2]="NO";
        }
